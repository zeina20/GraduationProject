...
# net = nn.Sequential( nn.Linear(18*18, 80), nn.ReLU(), nn.Linear(80, 80), nn.ReLU(), nn.Linear(80, 10), nn.LogSoftmax())

dataset="train"
data_path="D:\semester 7\graduation project\Comparing-the-Performance-of-Deepfake-Detection-Methods-on-Benchmark-Datasets-master"
method="mesonet"
img_save_path="D:\semester 7\graduation project\Comparing-the-Performance-of-Deepfake-Detection-Methods-on-Benchmark-Datasets-master"
epochs=3 
batch_size=32
lr=0.0001
folds=3
...
def main():
    ...
    DFDetector.train_method(dataset="train", data_path="D:\semester 7\graduation project\Comparing-the-Performance-of-Deepfake-Detection-Methods-on-Benchmark-Datasets-master", method="mesonet", img_save_path="D:\semester 7\graduation project\Comparing-the-Performance-of-Deepfake-Detection-Methods-on-Benchmark-Datasets-master", epochs=3, batch_size=32,
                     lr=0.0001, folds=3, augmentation_strength="weak", fulltrain="true",  face_margin=0.3, faces_available=False, seed=24)
    # else:
